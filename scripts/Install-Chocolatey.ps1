...
dism /online /Enable-Feature /all /FeatureName:RemoteServerAdministrationTools
dism /online /enable-feature /all /featurename:RemoteServerAdministrationTools-Roles-AD-DS
dism /online /enable-feature /all /featurename:RemoteServerAdministrationTools-Roles-AD-Powershell